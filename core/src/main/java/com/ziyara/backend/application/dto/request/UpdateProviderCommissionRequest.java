 ...
 * G1 Super Admin and G5 Sales/GM can set overrides; changes are audited.
 */
@Data
@Builder
@NoArgsConstructor
...
public class UpdateProviderCommissionRequest {
    ...
    @Schema(description = "Commission percentage (0â€“100). Null or omit to reset to default 10%")
    @DecimalMin("0")
    @DecimalMax("100")
