...
import com.ziyarah.application.dto.TicketCommentRequest;
import com.ziyarah.application.dto.TicketRequest;
import com.ziyarah.application.dto.TicketResponse;
import com.ziyarah.domain.entity.InternalTicket;
import com.ziyarah.domain.entity.TicketComment;
import com.ziyarah.domain.enums.TicketPriority;
import com.ziyarah.domain.enums.TicketStatus;
import com.ziyarah.domain.enums.TicketType;
import com.ziyarah.domain.repository.InternalTicketRepository;
...
public class InternalTicketController {
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> createTicket(
        ...
        ticket.setReporterId(UUID.randomUUID()); // TODO: Get from authenticated user
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(toResponse(savedTicket), "Ticket created successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> updateTicket(
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(updatedTicket), "Ticket updated successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> acknowledgeTicket(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket acknowledged"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> assignTicket(
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket assigned successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> startProgress(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Work started on ticket"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> requestInfo(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Information requested"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> moveToTesting(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket moved to testing"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> resolveTicket(
        ...
        UUID resolvedBy = UUID.randomUUID(); // TODO: Get from authenticated user
        ticket.resolve(resolvedBy, notes, summary);
        InternalTicket savedTicket = ticketRepository.save(ticket);
        
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket resolved"));
    }
    
    @PostMapping("/{id}/verify")
    @Operation(summary = "Verify resolution", description = "Verify the ticket resolution")
    public ResponseEntity<ApiResponse<TicketResponse>> verifyTicket(@PathVariable UUID id) {
        InternalTicket ticket = ticketRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Ticket not found"));
        
        UUID verifiedBy = UUID.randomUUID(); // TODO: Get from authenticated user
        ticket.verify(verifiedBy);
        InternalTicket savedTicket = ticketRepository.save(ticket);
        
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket verified"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> closeTicket(@PathVariable UUID id) {
        ...
        UUID closedBy = UUID.randomUUID(); // TODO: Get from authenticated user
        ticket.close(closedBy);
        InternalTicket savedTicket = ticketRepository.save(ticket);
        
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket closed"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> reopenTicket(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket reopened"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketResponse>> cancelTicket(
        ...
        UUID cancelledBy = UUID.randomUUID(); // TODO: Get from authenticated user
        ticket.cancel(cancelledBy, reason);
        InternalTicket savedTicket = ticketRepository.save(ticket);
        
        return ResponseEntity.ok(ApiResponse.success(toResponse(savedTicket), "Ticket cancelled"));
    }
    ...
    public ResponseEntity<ApiResponse<TicketComment>> addComment(
        ...
        comment.setUserId(UUID.randomUUID()); // TODO: Get from authenticated user
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(savedComment, "Comment added successfully"));
    }
