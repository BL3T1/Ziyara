...
public class Booking {
    ...
    public void setDiscountCodeId(UUID discountCodeId) { this.discountCodeId = discountCodeId; }
    ...
    public boolean isIdDocumentVerified() { return idDocumentVerified; }
    public void setIdDocumentVerified(boolean idDocumentVerified) { this.idDocumentVerified = idDocumentVerified; }
