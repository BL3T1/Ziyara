...
function getNotificationLink(n: NotificationDto): string | null {
  switch (n.type) {
    ...
    case 'PROVIDER_PENDING_REVIEW':
    case 'PROVIDER_EXPIRY_WARNING':
    case 'PROVIDER_EXPIRED':
      return n.referenceId ? `/admin/providers/${n.referenceId}` : '/admin/providers'
    case 'MEDIA_SUBMISSION_PENDING':
      return '/admin/media-submissions'
    case 'STAFF_USER_CREATED':
      return '/admin/staff'
...
export function NotificationPanel({ isOpen, onClose, anchorRef, onMarkAllRead, onUnreadCount }: NotificationPanelProps) {
  ...
  const handleMediaApprove = async (e: React.MouseEvent, n: NotificationDto) => {
    e.stopPropagation()
              ...
              return (
                ...
                >
                  ...
                  {n.type === 'MEDIA_SUBMISSION_PENDING' && n.referenceId && (
                    <div className="mt-2 flex items-center gap-3">
                      <button
                        ...
                        onClick={(e) => handleMediaApprove(e, n)}
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    {link && (
                      <span className="text-xs text-primary opacity-60">→</span>
                    )}
                  </div>
                </li>
              )
